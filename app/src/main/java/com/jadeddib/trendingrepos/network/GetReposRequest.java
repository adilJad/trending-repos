...
public class GetReposRequest extends StringRequest {
    ...
    public GetReposRequest(String startDate, Response.Listener<String> listener,
                           Response.ErrorListener errorListener) {

        super(Method.GET, GET_REPOS_REQUEST_URL + startDate + "&sort=stars&order=desc", listener,
                errorListener);
    }
